 ...
 * File Name: Timer.c
 *
 * Description: C file to Initilaze Systick Timer.
 *
 * Author: 
 *
 ******************************************************************************/
...
void SysTick_Handler(void)
{
    ...
    /* No need to clear the trigger flag bit it's cleared by HW */
}

/*******************************************************************************
* Service Name: Systick_oneshotConfig
...
* Parameters (out): None
* Return value: None
* Description: Function to Setup the SysTick Timer configuration to count n ms:
*              - Set the Reload value
*******************************************************************************/
void Systick_oneshotConfig(uint32 Tick_Time)
{
  SYSTICK_CTRL_REG = 0;    /*Disable the SysTick Timer by Clear the ENABLE Bit*/
  SYSTICK_RELOAD_REG = 15999 * Tick_Time; /*Set the Reload value to count n ms*/
...
* Parameters (out): None
* Return value: None
* Description: - Enable SysTick Timer with System clock 16Mhz
*******************************************************************************/
